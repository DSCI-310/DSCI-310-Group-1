...
all : results/figures/explore_numeric.png results/figures/explore_cat.png results/exploratory-stu-mat.csv results/coeff-table.csv results/figures/predvsfinal.png results/cvtable.csv results/finaltable.csv  analysis/_build/html/index.html results/report/index.html
...
# create a copy of the report in results/
results/report/index.html: 
	cp -r analysis/_build/html results/report
