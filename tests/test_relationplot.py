...
class Test_Square_Plot:
    ...
    def test_good_5items_incomplete(self):
        ...
        test_axs, _ = relationPlots.make_relation_plots(X_train, y_train, ["studytime", "Medu", "Fedu", "goout", "traveltime"], 
    ...
    def test_good_4items_complete(self):
        ...
        test_axs, _ = relationPlots.make_relation_plots(X_train, y_train, ["Pstatus", "Mjob", "Fjob", "romantic"], 
    ...
    def test_bad_not_dataframes_1(self):
        ...
        with pytest.raises(TypeError) as e_info:
            test_axs, _ = relationPlots.make_relation_plots(X_train, "hello", ["Pstatus", "Mjob", "Fjob", "romantic"], 
    ...
    def test_bad_not_dataframes_2(self):
        ...
        with pytest.raises(TypeError) as e_info:
            test_axs, _ = relationPlots.make_relation_plots("hello", y_train, ["Pstatus", "Mjob", "Fjob", "romantic"], 
                                    ["P status vs grade", "Mother job vs grade", "Father Job vs grade", "Relationship status vs grade"], "Sample")
            assert str(exc_info.value) == 'The first two arguments are not dataframes of equal length'
    ...
    def test_bad_dataframes_size(self):
        ...
        with pytest.raises(TypeError) as e_info:
            test_axs, _ = relationPlots.make_relation_plots(X_train, pd.DataFrame(), ["Pstatus", "Mjob", "Fjob", "romantic"], 
                                    ["P status vs grade", "Mother job vs grade", "Father Job vs grade", "Relationship status vs grade"], "Sample")
            assert str(exc_info.value) == 'The first two arguments are not dataframes of equal length'
    ...
    def test_bad_not_desired_not_list(self):
        ...
        with pytest.raises(TypeError) as e_info:
            test_axs, _ = relationPlots.make_relation_plots(X_train, y_train, [], 
                                    ["P status vs grade", "Mother job vs grade", "Father Job vs grade", "Relationship status vs grade"], "Sample")
            assert str(exc_info.value) == 'desiredFeatures is not a list of strings length at least 1'
        with pytest.raises(TypeError) as e_info:
            test_axs, _ = relationPlots.make_relation_plots(X_train, y_train, [1,2,3], 
                                    ["P status vs grade", "Mother job vs grade", "Father Job vs grade", "Relationship status vs grade"], "Sample")
            assert str(exc_info.value) == 'desiredFeatures is not a list of strings length at least 1'
        with pytest.raises(TypeError) as e_info:
            test_axs, _ = relationPlots.make_relation_plots(X_train, y_train, ["Pstatus"], 
                                    ["P status vs grade", "Mother job vs grade", "Father Job vs grade", "Relationship status vs grade"], "Sample")
            assert str(exc_info.value) == 'desiredFeatures is not a list of strings length at least 1'
    ...
    def test_bad_feature_dne(self):
        ...
        with pytest.raises(TypeError) as e_info:
            test_axs, _ = relationPlots.make_relation_plots(X_train, y_train, ["china", "Mjob", "Fjob", "romantic"], 
                                    ["P status vs grade", "Mother job vs grade", "Father Job vs grade", "Relationship status vs grade"], "Sample")
